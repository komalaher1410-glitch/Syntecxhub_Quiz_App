...
![Stars](https://img.shields.io/github/stars/YOUR_USERNAME/quizmaster?style=for-the-badge)
...
### 📝 Quiz Screen
![Quiz Screen](screenshots/quiz.svg)

### 🏆 Results Screen
![Results Screen](screenshots/results.svg)
...
- 📝 **10 Quiz Questions** — Multiple-choice questions with instant feedback & explanations
...
### Add more demo users
In `script.js`, add to the `USERS` object:
